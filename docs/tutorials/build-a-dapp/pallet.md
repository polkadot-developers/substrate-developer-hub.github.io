...
For example, FRAME includes a [Balances](https://substrate.dev/rustdocs/v2.0.0-rc3/pallet_balances/)
...
[Contracts](https://substrate.dev/rustdocs/v2.0.0-rc3/pallet_contracts/) pallet.

Even things like on-chain governance can be added to your blockchain by including pallets like
[Democracy](https://substrate.dev/rustdocs/v2.0.0-rc3/pallet_democracy/),
[Elections](https://substrate.dev/rustdocs/v2.0.0-rc3/pallet_elections/), and
[Collective](https://substrate.dev/rustdocs/v2.0.0-rc3/pallet_collective/).
...
> [`DispatchResult`](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/dispatch/type.DispatchResult.html)s.
