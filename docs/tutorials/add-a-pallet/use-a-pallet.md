...
[the `setName` dispatchable](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_nicks/enum.Call.html#variant.set_name)
...
[events](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_nicks/enum.RawEvent.html) emitted by the
...
[the `killName` dispatchable](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_nicks/enum.Call.html#variant.kill_name)
...
Template's
[chain specification](https://github.com/substrate-developer-hub/substrate-node-template/blob/v2.0.0-rc5/node/src/chain_spec.rs)
file is used to configure the
[Sudo pallet](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_sudo/index.html) to give Alice access
...
[the `Signed` origin](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_system/enum.RawOrigin.html#variant.Signed)
...
[`Sudid` event](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_sudo/enum.RawEvent.html#variant.Sudid)
...
[`DispatchError`](https://substrate.dev/rustdocs/v2.0.0-rc5/sp_runtime/enum.DispatchError.html) (the
Sudo pallet's
[`sudo` function](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_sudo/enum.Call.html#variant.sudo)
is the "outer" dispatch). In particular, this was an instance of
[the `DispatchError::Module` variant](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/dispatch/enum.DispatchError.html#variant.Module),
...
[the `Unnamed` variant](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_nicks/enum.Error.html#variant.Unnamed).
...
- [Nicks pallet docs](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_nicks/index.html)
