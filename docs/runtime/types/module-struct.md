...
The `Module` struct also implements the default getter methods for storage items and the query for storage metadata. Go to [Metadata of Your Module](TODO) section to give a glimpse at details. 
