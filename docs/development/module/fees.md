...
* `base_fee`: A fixed fee that is applied to every transaction. See
  [`TransactionBaseFee`](https://substrate.dev/rustdocs/master/srml_transaction_payment/trait.Trait.html#associatedtype.TransactionBaseFee).
* `length_fee`: A per-byte fee that is multiplied by the length, in bytes, of the encoded
  transaction. See
  [`TransactionByteFee`](https://substrate.dev/rustdocs/master/srml_transaction_payment/trait.Trait.html#associatedtype.TransactionByteFee).
* `weight_fee`: A per-weight-unit fee that is multiplied by the weight of the transaction. The
  ...
  [`WeightToFee`](https://substrate.dev/rustdocs/master/srml_transaction_payment/trait.Trait.html#associatedtype.WeightToFee)
...
variability. To fulfill this requirement, Substrate provides:
  ...
  - [`NextFeeMultiplier`](https://substrate.dev/rustdocs/master/srml_transaction_payment/struct.Module.html#method.next_fee_multiplier):
    A multiplier stored in the Transaction Payment module and configurable. 
  - [`FeeMultiplierUpdate`](https://substrate.dev/rustdocs/master/srml_transaction_payment/trait.Trait.html#associatedtype.FeeMultiplierUpdate):
