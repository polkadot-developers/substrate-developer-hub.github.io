...
> [Staking module](https://substrate.dev/rustdocs/v2.0.0/pallet_staking/index.html).
...
[Balances module](https://substrate.dev/rustdocs/v2.0.0/pallet_balances/index.html), these accounts
...
[Session module](https://substrate.dev/rustdocs/v2.0.0/pallet_session/index.html), which allows
...
[the `rotate_keys` RPC](https://substrate.dev/rustdocs/v2.0.0/sc_rpc/author/trait.AuthorApi.html#tymethod.rotate_keys)
...
- Visit the reference docs for the
  [session keys runtime API](https://substrate.dev/rustdocs/v2.0.0/sp_session/trait.SessionKeys.html).

- Take a look at the default
  [session keys in the Substrate node runtime](https://substrate.dev/rustdocs/v2.0.0/node_runtime/struct.SessionKeys.html).

- Take a look at
  [`substrate_application_crypto`](https://substrate.dev/rustdocs/v2.0.0/sp_application_crypto/index.html),
