...
[numeric value](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/weights/type.Weight.html).
...
The [System pallet](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_system/struct.Module.html) is
...
[Transaction Payment pallet](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_transaction_payment/index.html)
...
[`MaximumBlockLength`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_system/trait.Trait.html#associatedtype.MaximumBlockLength)
and
[`MaximumBlockWeight`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_system/trait.Trait.html#associatedtype.MaximumBlockWeight).
