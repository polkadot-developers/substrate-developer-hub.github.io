...
The [`ChainSpec` struct](https://substrate.dev/rustdocs/v3.0.0/sc_service/struct.GenericChainSpec.html)
...
- Rustdocs for the
  [`ChainSpec` struct](https://substrate.dev/rustdocs/v3.0.0/sc_service/struct.GenericChainSpec.html)
- Rustdocs for the
  [`ProtocolId` struct](https://substrate.dev/rustdocs/v3.0.0/sc_network/config/struct.ProtocolId.html)
