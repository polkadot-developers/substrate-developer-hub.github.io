...
be found in the
[Web3 research page](https://w3f-research.readthedocs.io/en/latest/polkadot/overview/2-token-economics.html?highlight=relay%20transaction#relay-chain-transaction-fees-and-per-block-transaction-limits).
