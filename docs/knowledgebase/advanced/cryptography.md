...
implements the [`Hasher` trait](https://substrate.dev/rustdocs/v3.0.0/sp_core/trait.Hasher.html).
...
[`Pair` trait](https://substrate.dev/rustdocs/v3.0.0/sp_core/crypto/trait.Pair.html).
...
- Take a look at the
  [`Hash`](https://substrate.dev/rustdocs/v3.0.0/sp_runtime/traits/trait.Hash.html) trait needed for
  implementing new hashing algorithms.
- Take a look at the [`Pair`](https://substrate.dev/rustdocs/v3.0.0/sp_core/crypto/trait.Pair.html)
