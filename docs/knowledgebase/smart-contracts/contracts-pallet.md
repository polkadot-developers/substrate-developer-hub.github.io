...
The [Contracts pallet](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_contracts/index.html) provides
...
- Visit the reference docs for the
  [Contracts module](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_contracts/index.html).
