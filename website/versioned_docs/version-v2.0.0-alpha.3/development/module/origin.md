...
id: version-v2.0.0-alpha.3-origin
original_id: origin
---
...
You can look at the source code of the [Sudo module](https://crates.parity.io/pallet_sudo/index.html) for a practical implementation of this.
...
* Visit the reference docs for the [`RawOrigin` enum](https://crates.parity.io/frame_system/enum.RawOrigin.html).
