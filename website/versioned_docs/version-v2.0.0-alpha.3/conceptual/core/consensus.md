---
title: Consensus
id: version-v2.0.0-alpha.3-consensus
...
Trait](https://crates.parity.io/sp_consensus/trait.SelectChain.html).
...
[Aura](https://crates.parity.io/sc_consensus_aura/index.html) provides a slot-based block
authoring mechanism. In Aura a known set of authorities take turns producing blocks.

### BABE

[BABE](https://crates.parity.io/sc_consensus_babe/index.html) also provides slot-based block
