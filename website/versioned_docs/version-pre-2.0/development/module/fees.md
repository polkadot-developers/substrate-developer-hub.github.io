...
* `weight_fee`: A per-weight-unit fee that is multiplied by the weight of the transaction. The
  ...
  Balance>`](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sr_primitives/traits/trait.Convert.html).
...
- [SignedExtension](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sr_primitives/traits/trait.SignedExtension.html)
