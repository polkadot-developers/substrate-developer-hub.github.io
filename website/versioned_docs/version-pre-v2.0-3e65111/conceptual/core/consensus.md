---
title: Consensus
id: version-pre-v2.0-3e65111-consensus
...
[`LongestChain` struct](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sc_client/struct.LongestChain.html). GRANDPA uses
...
[Aura](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sc_consensus_aura/index.html) provides a slot-based block
authoring mechanism. In Aura a known set of authorities take turns producing blocks.

### BABE

[BABE](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sc_consensus_babe/index.html) also provides slot-based block
...
[Proof-of-work](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sc_consensus_pow/index.html) block authoring is not
...
[GRANDPA](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sc_finality_grandpa/index.html) provides block
...
[`DigestItem`](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sp_runtime/enum.DigestItem.html), a message
