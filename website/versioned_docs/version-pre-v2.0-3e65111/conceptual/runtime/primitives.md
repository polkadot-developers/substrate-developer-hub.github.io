...
id: version-pre-v2.0-3e65111-primitives
...
- View the [`traits` defined in `sp-runtime`](https://substrate.dev/rustdocs/pre-v2.0-3e65111/sp_runtime/traits/index.html)
