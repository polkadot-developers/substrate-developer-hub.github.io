    ...
    return (
      <section>
        ...
        <HomeSplash
          ...
          description={
            <translate>
              Substrate is a modular framework that enables you to create purpose-built blockchains
              by composing custom or pre-built components.
            </translate>
          }
          ...
          <Container>
            <section className="intro-statement home-section">
              <span className="tagline">
                <translate>Why Use Substrate?</translate>
              </span>

              <h2 className="large h1">
                <translate>Focus on Your Strengths</translate>
              </h2>
              <p className="big">
                <translate>
                  Substrate's modular design means you can reuse battle-tested libraries while
                  building the custom components that matter most.
                </translate>
              </p>
            </section>
            ...
            <section className="intro-blocks home-section">
              <section className="intro-block">
                ...
                <section className="button-wrap">
                  <a href={docUrl("knowledgebase/runtime")} className="with-arrow">
              ...
              <section className="intro-block">
                ...
                <h4>
                  <translate>Client Libraries</translate>
                </h4>
                <p>
                  <translate>
                ...
                <section className="button-wrap">
                  <a href={docUrl("knowledgebase/integrate/polkadot-js")} className="with-arrow">
                    <translate>Learn More</translate>
                  </a>
                </section>
              </section>
              ...
              <section className="intro-block">
                ...
                <h4>
                  <translate>Smart Contracts</translate>
                </h4>
                <p>
                  <translate>
                ...
                <section className="button-wrap">
                  <a href="/tutorials/ink-smart-contracts-tutorial" className="with-arrow">
                    <translate>Learn More</translate>
                  </a>
                </section>
              </section>
              ...
              <div className="pt-5">
                <div className="row justify-content-center text-center py-3">
                  <div className="col-12 col-md-8">
                    ...
                    <h2 className="display-4 h1">
                      <translate>Everything you need to build a blockchain.</translate>
                    </h2>
                    <p className="big">
                      <translate>
              ...
              <div className="row py-5 features">
                ...
                <div className="col-12 col-md-4 mb-4">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <h3 className="mb-0">
                      <translate>Modular P2P Networking Stack</translate>
                    </h3>
                  </div>
                </div>
                ...
                <div className="col-12 col-md-4 mb-4">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <h3 className="mb-0">
                      <translate>Configurable Transaction Queue</translate>
                    </h3>
                  </div>
                </div>
                <div className="col-12 col-md-4 mb-4">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <h3 className="mb-0">
                      <translate>Flexible Runtime Library</translate>
                    </h3>
                  </div>
                </div>
                <div className="col-12 col-md-4">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <h3 className="mb-0">
                      <translate>Light Client Optimized</translate>
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div className="row justify-content-between align-items-center py-5 polkadot-row">
                ...
                <div className="col-12 col-md-5">
                  ...
                  <a className="action-link" href="https://polkadot.network/technology/">
                    <span>
                      <translate>Learn more about Polkadot</translate>
                    </span>
                  </a>
                </div>
              </div>
            ...
            <div className="container">
              <div className="row justify-content-between align-items-center py-5">
                <div className="col-12 col-md-5 order-2 order-md-1">
                  <h2 className="h1">
                    <translate>Smart Contract Ready</translate>
                  </h2>
                  <p className="large mb-4">
                    <translate>
                  ...
                  <a className="action-link" href={docUrl("knowledgebase/smart-contracts/")}>
                    <span>
                      <translate>Learn more about ink!</translate>
                    </span>
                  </a>
                </div>
            ...
            <div className="container">
              <div className="row justify-content-center text-center pt-5">
                <div className="col-12 col-md-10">
                  <span className="tagline">
                    <translate>Keep Exploring!</translate>
                  </span>
                  <h2 className="display-4 h1">
                    <translate>There are lots of ways to learn about Substrate.</translate>
                  </h2>
                </div>
              </div>
            </div>
                  ...
                  <div className="row justify-content-center">
                    <div className="col-12 col-lg-8">
                      <div className="py-5 py-md-0">
                        ...
                        <p className="mb-3">
                          <translate>
                            An open, collaborative group for learning about Substrate and connecting
                            with other builders.
                          </translate>
                        </p>
                        <a className="btn primary-color" href={pageUrl("seminar")}>
                  ...
                  <div className="row justify-content-center">
                    <div className="col-12 col-lg-8">
                      <div className="py-5 py-md-0">
                        ...
                        <a className="btn primary-color" href="https://substrate.dev/recipes">
            ...
            <div className="container">
              <div className="py-5">
                <div className="row justify-content-center text-center py-3">
                  <div className="col-12 col-md-10">
                    <h2 className="display-4 h1">
                      <translate>Ready to build with Substrate?</translate>
                    </h2>
                  </div>
                  <div className="col-12 col-md-8">
                    <p className="lead mb-4">
                      <translate>
                        Get started with our helpful documentation or ask questions in our technical
                        chat!
                      </translate>
                    </p>
                    <div className="d-flex justify-content-center">
                      <div className="px-1">
                        <a className="btn btn-lg primary-color" href={docUrl()}>
